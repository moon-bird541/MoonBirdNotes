        ...
        <header class="upload-header fade-rise-enter">
          <div class="header-copy">
            ...
            <p class="upload-subtitle">
              上传后系统会保留原始 <code>.md</code> 文件，并同步生成可直接展示的 HTML 内容，
              方便后续整理、预览和扩展展示页面。
            </p>
          </div>
          ...
          <aside class="upload-side fade-rise-enter-delay-2">
            ...
            <div class="preview-scroll">
              <div v-if="uploadedNote" class="preview-card">
                ...
                <article class="html-preview" v-html="uploadedNote.rendered_html"></article>
              </div>

              <div v-else class="preview-empty">
                <div class="preview-empty-mark">HTML</div>
                <h3>这里会出现渲染结果</h3>
                <p>上传成功后，将展示标题、文件地址以及 Markdown 转换后的 HTML 预览。</p>
              </div>
            </div>
          </aside>
        </section>
